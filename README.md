...
Для MacOS/Linux достаточно установить python3, и библиотеку Pandas выполнив в терминале: ```pip install pandas openpyxl```, далее просто запустить в терминале командой:  
